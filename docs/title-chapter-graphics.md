...
2026-08-04 통합 빌드는 편집본의 24,943픽셀을 원본 CLUT index로 역매핑했고,
`START.BIN +0x61528..+0x79528`의 384×256 index 평면만 변경했다. 최종 파일
빌드 렌더에서 한국어 로고가 확인됐으며 Disc 1·2 CUE의 재추출 해시도 각 디스크
manifest와 일치한다. 저장·디스크 경로 검증은 통과했지만 실제 타이틀 화면은
PCSX-Redux clean boot로 다시 확인해야 한다.
