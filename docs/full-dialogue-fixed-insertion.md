...
`ee4e66913d2ac7ca10d95ffe329647d61b0ec02707e0550c600fda9b6e6c80eb`이다.
...
| 계획한 직접 엔트리 | 5,783 |
| primary 매핑 문자 | 988 |
| 확장 후 17글리프 행 한도 위반 | 286 |
| 그중 51글리프 총량 초과 | 18 |
| 원본 안전 슬롯 초과 | 1,380 |
| 최종 바이트가 온전한 엔트리 | 4,449 |
| 앞 엔트리에 일부 덮인 엔트리 | 1,334 |
| 화자·음성 선두 제어 손상 | 1,237 |
| 보호 이름 토큰 불일치 | 1 |
...
1,334개 후속 스트림은 일부가 앞 대사로 덮인다. 이 정책은 첫 실제 충돌을
...
| `ALLBIN.BIN` 변경 | 221,840바이트, 48,462 범위 |
| 변경 raw sector | 235 |
...
출력 Track 1 SHA-256은
`f194c1db24591244aa69bd4072b2e8788f3eb6f4824de03002aa14756c9c8419`,
CUE SHA-256은
...
- 1,380개 원본 슬롯 충돌을 해소하지 않았다.
- 1,237개 후속 엔트리에서 화자·음성 제어 손상이 예상된다.
- 무포인터 연속 페이지 모집단과 번역이 완성되지 않았다.
- 17×3 위반 286개와 51글리프 초과 18개는 사람 검수·축약이 필요하다.
