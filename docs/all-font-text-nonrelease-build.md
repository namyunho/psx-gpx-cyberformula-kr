...
- `u02..u19` 순차 페이지 291개와 `u30..u34` 경기 색인 페이지 325개
- 고정 주인공명 `시바 / 세이치로`, 화자명 34개
- 이름 등록 폰트 UI 리터럴 4개
- `u38` 미니게임 322개
- 추가 `u38` 미니게임 분기·결과 73개와 `u39` 저장 메시지 27개
- `u43` 코스 설명 57개와 머신 설정 설명 12개

일반 대사 빌더가 보고하는 6,482개는 직접 대사, 무포인터 페이지와 추가
스토리·경기 616개의 합이다. 특수 화면 391개와 추가 `u38/u39` 100개는
